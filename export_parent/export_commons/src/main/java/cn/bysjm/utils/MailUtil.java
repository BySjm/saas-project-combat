...
public class MailUtil {
   ...
   public static void sendMsg(String to ,String subject ,String content) throws Exception{
      ...
      //4.设置消息的发送者
      Address fromAddr = new InternetAddress("bysjmjl@163.com");
      ...
      //9.设置火箭的发射目标
      transport.connect("smtp.163.com", "bysjmjl@163.com", "asd123"); //密码 授权密码!=登陆密码
      //10.发送
   ...
   public static void main(String[] args) throws Exception {
      MailUtil.sendMsg("1183781747@qq.com" , "SAAS货代云平台", "祝您生日快乐");
