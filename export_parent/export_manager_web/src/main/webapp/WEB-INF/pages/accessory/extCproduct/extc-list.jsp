...
<div id="frameContent" class="content-wrapper" style="margin-left:0px;">
    ...
    <section class="content">
        ...
        <div class="panel panel-default">
            ...
            <form id="editForm" action="${ctx}/accessory/extCproduct/edit.do" method="post" enctype="multipart/form-data">
                <input type="hidden" name="contractProductId" value="${contractProductId}">
                &lt;%&ndash;<input type="hidden" name="contractId" value="${contractId}">&ndash;%&gt;
        ...
        <div class="box box-primary">
                ...
                <div class="table-box">
                    ...
                    <div class="pull-left">
                        <div class="form-group form-inline">
                            <div class="btn-group">
                                <button type="button" class="btn btn-default" title="新建" onclick='location.href="${ctx}/accessory/extCproduct/toAdd.do?contractProductId=${contractProductId}"'><i class="fa fa-file-o"></i> 新建</button>
                    ...
                    <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                        ...
                        <c:forEach items="${page.list}" var="o" varStatus="status">
                            <tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'" >
                                ...
                                <td>${o.amount}</td>
                                <td>
                                    <a href="${ctx}/accessory/extCproduct/toUpdate.do?id=${o.id}&contractProductId=${o.contractProductId}">[修改]</a>
                                    <a href="${ctx}/accessory/extCproduct/delete.do?id=${o.id}&contractProductId=${o.contractProductId}">[删除]</a>
            ...
            <div class="box-footer">
                <jsp:include page="../../common/page.jsp">
                    <jsp:param value="accessory/contractProduct/list.do?contractId=${contractId}" name="pageUrl"/>
                </jsp:include>
            </div>
            <!-- /.box-footer-->
        </div>
