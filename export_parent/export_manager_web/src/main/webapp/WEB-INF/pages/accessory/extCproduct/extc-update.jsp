...
<div id="frameContent" class="content-wrapper" style="margin-left:0px;">
    ...
    <section class="content">
        ...
        <div class="panel panel-default">
            ...
            <form id="editForm" action="${ctx}/accessory/extCproduct/edit.do?contractProductId=${contractProductId}" method="post" enctype="multipart/form-data">
                ...
                <div class="row data-type" style="margin: 0px">
                    ...
                    <div class="col-md-4 data  ">
                        <textarea class="form-control"  placeholder="货物描述" name="productDesc">${extCproduct.productDesc}</textarea>
                    </div>--%>
