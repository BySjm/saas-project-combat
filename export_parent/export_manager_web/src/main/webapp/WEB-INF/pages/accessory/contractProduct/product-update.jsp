...
<%--            enctype="multipart/form-data"--%>
            <form id="editForm" action="${ctx}/accessory/contractProduct/edit.do" method="post" enctype="multipart/form-data">
                <input hidden="text" name="id" value="${contractProduct.id}">
                <input hidden="text" name="contractId" value="${contractProduct.contractId}">
                <input hidden="text"  name="factoryName" id="factoryName" value="${contractProduct.factoryName}">
                <div class="row data-type" style="margin: 0px">
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="公司姓名" name="companyName" value="${contractProduct.companyName}">
                    </div>

                    <div class="col-md-2 title">公司id</div>
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="公司id" name="companyId" value="${contractProduct.companyId}">
                    </div>--%>
