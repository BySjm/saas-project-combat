                        ...
                        <div class="form-group form-inline">
                            <div class="btn-group">
                                <button type="button" class="btn btn-default" title="新建"
                                        onclick='location.href="/system/role/toAdd.do"'><i class="fa fa-file-o"></i> 新建
                                </button>
                                ...
                                <button type="button" class="btn btn-default" title="权限" onclick="findModuleByRoleId()">
                                    <i class="fa fa-users"></i> 权限
                                </button>
                            </div>
                        </div>
                    </div>
                            ...
                            <tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'">
                                ...
                                <th class="text-center">
                                    <button type="button" class="btn bg-olive btn-xs"
                                            onclick='location.href="/system/role/toUpdate.do?id=${o.id}"'>编辑
                                    </button>
                                </th>
                            </tr>
                        </c:forEach>
