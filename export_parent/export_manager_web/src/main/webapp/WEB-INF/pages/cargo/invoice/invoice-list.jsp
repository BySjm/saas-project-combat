...
<script>
    function deleteById() {
        ...
        if(id) {
            if(confirm("你确认要删除此条记录吗？")) {
                location.href="${ctx}/cargo/invoice/delete.do?invoiceId="+id;
            }
        }else{
    ...
    function submit() {
        var id = getCheckId()
        if(id) {
            location.href="${ctx}/cargo/invoice/submit.do?invoiceId="+id;
        }else{
            alert("请勾选待处理的记录，且每次只能勾选一个")
        }
    }
    ...
    function cancel() {
        var id = getCheckId()
        if(id) {
            location.href="${ctx}/cargo/invoice/cancel.do?invoiceId="+id;
        }else{
            alert("请勾选待处理的记录，且每次只能勾选一个")
        }
    }
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <c:if test="${o.state==0}">
                                    ...
                                    <a href="${ctx }/cargo/invoice/list.do?id=${o.invoiceId}">[待定内容]</a>
                                </c:if>
                            </td>
                        </tr>
                    </c:forEach>
